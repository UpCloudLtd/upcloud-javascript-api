...
const matchers = {
  toBe(received, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBe') +
    '\n\n' +
    ...
    () => {
      ...
      (0, _jestGetType2.default)(received) === (0, _jestGetType2.default)(expected) && (
      (0, _jestGetType2.default)(received) === 'object' || (0, _jestGetType2.default)(expected) === 'array') &&
      (0, _jasmine_utils.equals)(received, expected, [_utils.iterableEquality]);
      ...
      return (
        (0, _jestMatcherUtils.matcherHint)('.toBe') +
        '\n\n' +
  ...
  toBeCloseTo(actual, expected) {let precision = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeCloseTo', 'received', 'expected, precision') +
    '\n\n' +
    `Expected value not to be close to (with ${(0, _jestMatcherUtils.printExpected)(
    precision)
    }-digit precision):\n` +
    `  ${(0, _jestMatcherUtils.printExpected)(expected)}\n` +
    `Received:\n` +
    ...
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toBeCloseTo', 'received', 'expected, precision') +
    '\n\n' +
    `Expected value to be close to (with ${(0, _jestMatcherUtils.printExpected)(
    precision)
    }-digit precision):\n` +
    `  ${(0, _jestMatcherUtils.printExpected)(expected)}\n` +
    `Received:\n` +
  ...
  toBeDefined(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeDefined', 'received', '') +
    '\n\n' +
  ...
  toBeFalsy(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeFalsy', 'received', '') +
    '\n\n' +
  ...
  toBeGreaterThan(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeGreaterThan') +
    '\n\n' +
    ...
    `  ${(0, _jestMatcherUtils.printReceived)(actual)}` :
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toBeGreaterThan') +
    '\n\n' +
  ...
  toBeGreaterThanOrEqual(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeGreaterThanOrEqual') +
    '\n\n' +
    ...
    `  ${(0, _jestMatcherUtils.printReceived)(actual)}` :
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toBeGreaterThanOrEqual') +
    '\n\n' +
  ...
  toBeInstanceOf(received, constructor) {
    ...
    if (constType !== 'function') {
      throw new Error(
      (0, _jestMatcherUtils.matcherHint)('[.not].toBeInstanceOf', 'value', 'constructor') +
      `\n\n` +
  ...
  toBeLessThan(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeLessThan') +
    '\n\n' +
    ...
    `  ${(0, _jestMatcherUtils.printReceived)(actual)}` :
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toBeLessThan') +
    '\n\n' +
  ...
  toBeLessThanOrEqual(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeLessThanOrEqual') +
    '\n\n' +
    ...
    `  ${(0, _jestMatcherUtils.printReceived)(actual)}` :
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toBeLessThanOrEqual') +
    '\n\n' +
  ...
  toBeNaN(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeNaN', 'received', '') +
    '\n\n' +
  ...
  toBeNull(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeNull', 'received', '') +
    '\n\n' +
  ...
  toBeTruthy(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeTruthy', 'received', '') +
    '\n\n' +
  ...
  toBeUndefined(actual, expected) {
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toBeUndefined', 'received', '') +
    '\n\n' +
  ...
  toContain(collection, value) {
    ...
    if (Array.isArray(collection) || typeof collection === 'string') {
      ...
      try {
        ...
        throw new Error(
        (0, _jestMatcherUtils.matcherHint)('[.not].toContainEqual', 'collection', 'value') +
        '\n\n' +
    ...
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toContain', collectionType, 'value') +
    '\n\n' +
  ...
  toContainEqual(collection, value) {
    ...
    const pass =
    converted.findIndex(item => (0, _jasmine_utils.equals)(item, value, [_utils.iterableEquality])) !==
    -1;
    const message = pass ?
    () =>
    (0, _jestMatcherUtils.matcherHint)('.not.toContainEqual', collectionType, 'value') +
    '\n\n' +
    `Expected ${collectionType}:\n` +
    `  ${(0, _jestMatcherUtils.printReceived)(collection)}\n` +
  ...
  toHaveLength(received, length) {
    ...
    {
      throw new Error(
      (0, _jestMatcherUtils.matcherHint)('[.not].toHaveLength', 'received', 'length') +
      '\n\n' +
    ...
    `  ${(0, _jestMatcherUtils.printReceived)(received.length)}` :
    () =>
    (0, _jestMatcherUtils.matcherHint)('.toHaveLength', 'received', 'length') +
    '\n\n' +
  ...
  toHaveProperty(object, keyPath, value) {
    ...
    if (!object && typeof object !== 'string' && typeof object !== 'number') {
      throw new Error(
      (0, _jestMatcherUtils.matcherHint)('[.not].toHaveProperty', 'object', 'path', {
    ...
    const result = (0, _utils.getPath)(object, keyPath);const
    lastTraversedObject = result.lastTraversedObject,hasEndProp = result.hasEndProp;

    const pass = valuePassed ?
    (0, _jasmine_utils.equals)(result.value, value, [_utils.iterableEquality]) :
    hasEndProp;
  ...
  toMatch(received, expected) {
    if (typeof received !== 'string') {
      throw new Error(
      (0, _jestMatcherUtils.matcherHint)('[.not].toMatch', 'string', 'expected') +
      '\n\n' +
    ...
    typeof expected === 'string' ? (0, _jestRegexUtil.escapeStrForRegex)(expected) : expected).
    test(received);
    const message = pass ?
    () =>
