...
(function(root, factory) {
   ...
   * @module model/AddIpRequest
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>AddIpRequest</code>.
   * @alias module:model/AddIpRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AddIpRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddIpRequest} obj Optional instance to populate.
   * @return {module:model/AddIpRequest} The populated <code>AddIpRequest</code> instance.
   */
