...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(
      require('../ApiClient'),
      require('./PriceListResponsePrices'),
    );
  } else {
    ...
    root.upcloud.PriceListResponse = factory(
      root.upcloud.ApiClient,
      root.upcloud.PriceListResponsePrices,
    );
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('prices')) {
        obj['prices'] = PriceListResponsePrices.constructFromObject(
          data['prices'],
        );
      }
    }
