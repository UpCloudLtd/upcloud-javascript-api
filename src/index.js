...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(
      [
        ...
        'model/AddIpRequest',
        'model/AddressFamily',
        'model/AssignIpResponse',
        'model/AttachStorageDeviceRequest',
        'model/AvailablePlanListResponse',
        'model/AvailablePlanListResponsePlans',
        'model/BackupRule',
        'model/CloneStorageRequest',
        'model/ConfigurationListResponse',
        'model/ConfigurationListResponseServerSizes',
        ...
        'model/FirewallRuleListResponseFirewallRules',
        'model/FirewallRuleRequest',
        'model/IpAddress',
        'model/IpAddressListResponse',
        'model/IpAddresses',
        'model/ModifyIpRequest',
        ...
        'model/SuccessStoragesResponseStorages',
        'model/Tag',
        'model/TagCreateRequest',
        'model/TagListResponse',
        'model/TagListResponseTags',
        'model/TagServers',
        'model/TemplitizeStorageRequest',
        'model/Timezone',
        'model/TimezoneListResponse',
        'model/TimezoneListResponseTimezones',
        'model/Zone',
        'model/ZoneListResponse',
        'model/ZoneListResponseZones',
        'api/AccountApi',
        'api/FirewallApi',
        'api/IPAddressApi',
        'api/PlanApi',
    ...
    module.exports = factory(
      ...
      require('./model/AddIpRequest'),
      require('./model/AddressFamily'),
      require('./model/AssignIpResponse'),
      require('./model/AttachStorageDeviceRequest'),
      require('./model/AvailablePlanListResponse'),
      require('./model/AvailablePlanListResponsePlans'),
      require('./model/BackupRule'),
      require('./model/CloneStorageRequest'),
      require('./model/ConfigurationListResponse'),
      require('./model/ConfigurationListResponseServerSizes'),
      ...
      require('./model/ErrorStatus'),
      require('./model/FirewallRule'),
      require('./model/FirewallRuleCreateResponse'),
      require('./model/FirewallRuleListResponse'),
      require('./model/FirewallRuleListResponseFirewallRules'),
      require('./model/FirewallRuleRequest'),
      require('./model/IpAddress'),
      require('./model/IpAddressListResponse'),
      require('./model/IpAddresses'),
      require('./model/ModifyIpRequest'),
      ...
      require('./model/ServerSize'),
      require('./model/ServerState'),
      require('./model/ServerStorageDevices'),
      require('./model/ServerTags'),
      require('./model/StopServer'),
      require('./model/StopServerRequest'),
      require('./model/Storage'),
      require('./model/StorageAccessType'),
      require('./model/StorageBackups'),
      require('./model/StorageDevice'),
      require('./model/StorageDeviceDetachRequest'),
      require('./model/StorageDeviceLoadRequest'),
      require('./model/StorageServers'),
      require('./model/StorageState'),
      require('./model/StorageTier'),
      require('./model/StorageType'),
      require('./model/SuccessStoragesResponse'),
      require('./model/SuccessStoragesResponseStorages'),
      require('./model/Tag'),
      require('./model/TagCreateRequest'),
      require('./model/TagListResponse'),
      require('./model/TagListResponseTags'),
      require('./model/TagServers'),
      require('./model/TemplitizeStorageRequest'),
      require('./model/Timezone'),
      require('./model/TimezoneListResponse'),
      require('./model/TimezoneListResponseTimezones'),
      require('./model/Zone'),
      require('./model/ZoneListResponse'),
      require('./model/ZoneListResponseZones'),
      require('./api/AccountApi'),
      require('./api/FirewallApi'),
      require('./api/IPAddressApi'),
      require('./api/PlanApi'),
      require('./api/PricesApi'),
      require('./api/ServerApi'),
      require('./api/StorageApi'),
      require('./api/TagApi'),
      require('./api/TimezoneApi'),
      require('./api/ZoneApi'),
    );
  }
})(function(
  ...
  var exports = {
    ...
    /**
     * The ModifyTagRequest model constructor.
     * @property {module:model/ModifyTagRequest}
     */
