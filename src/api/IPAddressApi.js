...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.upcloud.IPAddressApi = factory(
      root.upcloud.ApiClient,
      root.upcloud.AddIpRequest,
      root.upcloud.AssignIpResponse,
      root.upcloud.Error,
      root.upcloud.IpAddressListResponse,
      root.upcloud.ModifyIpRequest,
    );
  }
})(this, function(
  ApiClient,
  ...
  var exports = function(apiClient) {
    ...
    this.addIp = function(opts) {
      return this.addIpWithHttpInfo(opts).then(function(response_and_data) {
    ...
    this.deleteIp = function(ip) {
      return this.deleteIpWithHttpInfo(ip).then(function(response_and_data) {
        return response_and_data.data;
      });
    };
    ...
    this.getDetailsWithHttpInfo = function(ip) {
      ...
      if (ip === undefined || ip === null) {
        throw new Error(
          "Missing the required parameter 'ip' when calling getDetails",
        );
      }
    ...
    this.getDetails = function(ip) {
      return this.getDetailsWithHttpInfo(ip).then(function(response_and_data) {
        return response_and_data.data;
      });
    };
    ...
    this.listIps = function() {
      return this.listIpsWithHttpInfo().then(function(response_and_data) {
        return response_and_data.data;
      });
    };
    ...
    this.modifyIpWithHttpInfo = function(ip, opts) {
      ...
      if (ip === undefined || ip === null) {
        throw new Error(
          "Missing the required parameter 'ip' when calling modifyIp",
        );
      }
    ...
    this.modifyIp = function(ip, opts) {
      return this.modifyIpWithHttpInfo(ip, opts).then(function(
        response_and_data,
      ) {
        return response_and_data.data;
      });
