...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new upcloud.ServerSize();
  });
  ...
  describe('ServerSize', function() {
    it('should create an instance of ServerSize', function() {
      // uncomment below and update the code to test ServerSize
      //var instane = new upcloud.ServerSize();
      //expect(instance).to.be.a(upcloud.ServerSize);
    });
