...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new upcloud.ServerListResponse();
  });
  ...
  describe('ServerListResponse', function() {
    it('should create an instance of ServerListResponse', function() {
      // uncomment below and update the code to test ServerListResponse
