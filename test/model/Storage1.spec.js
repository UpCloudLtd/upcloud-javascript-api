...
(function(root, factory) {
  ...
  describe('Storage1', function() {
    it('should create an instance of Storage1', function() {
      // uncomment below and update the code to test Storage1
      //var instane = new upcloud.Storage1();
      //expect(instance).to.be.a(upcloud.Storage1);
    });
