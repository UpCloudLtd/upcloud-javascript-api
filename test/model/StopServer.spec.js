...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new upcloud.StopServer();
  });
  ...
  describe('StopServer', function() {
    it('should create an instance of StopServer', function() {
      // uncomment below and update the code to test StopServer
      //var instane = new upcloud.StopServer();
      //expect(instance).to.be.a(upcloud.StopServer);
    });
